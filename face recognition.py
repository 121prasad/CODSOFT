...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # first header image  
        img=Image.open(r"C:\Users\prasa\Desktop\internship\1_img.jpeg")
        ...
        # backgorund image 
        bg1 = Image.open("1_img.jpeg")#bg2.jpg
        img = img.resize((1366, 130), Image.LANCZOS)
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\prasa\Desktop\internship\1_img.jpeg")
